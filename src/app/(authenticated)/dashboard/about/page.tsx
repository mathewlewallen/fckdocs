...
import { about, person, social } from '@fck/lib/once-ui/content';
  ...
  return (
    <Column maxWidth="m">
      ...
      <Flex fillWidth mobileDirection="column" horizontal="center">
        ...
        <Column className="block-align" flex={9} maxWidth={40}>
          <Column
          ...
          >
            ...
            <Heading className="text-align" variant="display-strong-xl">
              {person.name}
            </Heading>
            <Text
