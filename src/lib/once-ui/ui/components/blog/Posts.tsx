...
import { Grid } from "@fck/lib/once-ui/ui/components";
...
export function Posts({ range, columns = "1", thumbnail = false, allBlogs }: PostsProps) {
  const blogsToDisplay = range ? allBlogs.slice(range[0] - 1, range[1]) : allBlogs;
